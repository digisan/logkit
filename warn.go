...
func WarnOnErr(format string, v ...any) {
	logger(2, WARN, format, v...)
}

// WarnOnErrWhen : write error into Console OR File
func WarnOnErrWhen(condition bool, format string, v ...any) {
	if condition {
		logger(2, WARN, format, v...)
	}
}
